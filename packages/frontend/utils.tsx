...
export const citiesWithCoordinates: { [key: string]: { lat: number; lon: number } } = {
  ...
  // Skiing cities – Andes and Patagonia
  Bariloche: { lat: -41.1335, lon: -71.3103 },
  ValleNevado: { lat: -33.3922, lon: -70.3300 },
  CerroCastor: { lat: -54.8019, lon: -68.3192 },
